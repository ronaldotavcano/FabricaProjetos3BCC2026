      ...
      <div className="flex flex-col items-center gap-14 w-full px-6">
        ...
        >
          <input
            ...
            className="w-full max-w-[420px] h-16 px-6 text-2xl rounded-[10px] border-[2px] border-white bg-transparent text-white placeholder:text-slate-400 outline-none"
          />

          <button
            type="submit"
            className="w-[130px] h-16 text-2xl rounded-[10px] border-[2px] border-white bg-blue-500 text-white transition hover:bg-white hover:text-black"
          >
            Buscar
          </button>
        </form>
